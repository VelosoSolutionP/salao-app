...
export const metadata: Metadata = { title: "Entrar — Veloso Solution" };
    ...
    <div className="min-h-screen flex">
      ...
      >
        ...
        <div className="relative z-10 flex items-center gap-3">
          ...
          <div>
            <p className="text-white font-black text-base leading-tight tracking-tight">Veloso Solution</p>
        ...
        <div className="relative z-10 space-y-8">
          <div>
            <h1 className="leading-[1.05] tracking-tight">
              <span className="block text-[3rem] font-black text-white">Gerencie seu</span>
              <span
              ...
              <span className="block text-[3rem] font-black text-white">inteligência.</span>
            </h1>
            <p className="text-zinc-400 mt-5 text-[15px] leading-relaxed max-w-sm">
              Agenda, equipe, estoque e finanças em um painel elegante.
              Para barbearias e salões masculinos e femininos.
            </p>
          </div>
        ...
        >
          ...
          <p className="text-zinc-300 text-sm italic leading-relaxed">
            "Reduzi o no-show em 70% com os lembretes automáticos e tenho controle total do estoque em tempo real."
          </p>
      ...
      <div className="flex-1 flex flex-col justify-center bg-white px-6 py-12 lg:px-16">
        ...
        <div className="lg:hidden flex items-center gap-2.5 mb-10">
          ...
          <span className="font-black text-gray-900 text-base tracking-tight">Veloso Solution</span>
        </div>

        <div className="w-full max-w-sm mx-auto">
          {/* Header */}
          <div className="mb-8">
            <p className="text-xs font-black uppercase tracking-widest text-violet-500 mb-2">Veloso Solution</p>
