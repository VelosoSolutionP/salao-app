...
import { CalendarDays, Scissors, LogOut } from "lucide-react";

export function ClienteNav({ name }: { name: string }) {
    ...
    <>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-white font-black text-base leading-tight truncate max-w-[180px]">{name}</p>
        </div>
        <button
